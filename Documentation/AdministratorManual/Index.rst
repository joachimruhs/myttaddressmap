...
To use your own mapIcons insert your mapIcons into the directory fileadmin/ext/myttaddresmap/Resources/Public/Icons. Insert in this
directory your icons which then can be selected in your tt_address data records.
